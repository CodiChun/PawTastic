...
RENAME TABLE SERVICES TO pet_tastic.SERVICE;
ALTER TABLE CUT_CARD DROP COLUMN Previous_Appointment_Date;
ALTER TABLE CUT_CARD DROP COLUMN Previous_Service;
ALTER TABLE CUT_CARD ADD COLUMN Prev_Appt_ID INT;